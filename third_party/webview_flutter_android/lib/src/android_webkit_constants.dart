...
class WebViewClientConstants {
  ...
  /// The WebView renderer process went away (OOM, WebView provider update, or
  /// crash).
  ///
  /// WanAndroid Flutter local patch: synthetic sentinel with no counterpart in
  /// android.webkit; reported over RENDER_PROCESS_GONE_CHANNEL by the local
  /// `onRenderProcessGone` override and mapped to
  /// [android_webview.WebResourceErrorType.webContentProcessTerminated].
  static const int errorWebContentProcessTerminated = -100;
